...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIII2024Summer24wmLHEGS-02058.root'),
...
process.generator = cms.EDFilter("Pythia8ConcurrentHadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            "HiddenValley:pTminFSR = 10       ! pT cut off on dark shower (IR regulator)",
            ...
            "4900101:m0 = 10.0          ! Dark Quark Mass",
            "4900102:m0 = 10.0          ! Dark Quark Mass",
            "4900111:m0 = 35                       ! Setting pion Mass",
            "4900211:m0 = 30                       ! Setting pion Mass",
            "4900221:m0 = 100                      ! Setting eta Mass",
            "4900113:m0 = 70                      ! Setting rho Mass",
            "4900213:m0 = 70                      ! Setting rho Mass",
            "4900113:addChannel = 1 1.00 91 4900211 -4900211",
            "4900213:addChannel = 1 1.00 91 4900211 4900111",
            "9900015:all = GeneralResonance void 1 0 0 15.0 0.001 0. 0. 0.        ! dark photon A'",
