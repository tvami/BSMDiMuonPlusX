...
config.General.requestName = 'H2ToH1H3To2MuInv_MH2-250_MH3-15_GENSIM_2024_v1_13p6TeV'

config.section_('JobType')
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'H2ToH1H3To2MuInv_MH2-250_MH3-15_GENSIM_cfg.py'
