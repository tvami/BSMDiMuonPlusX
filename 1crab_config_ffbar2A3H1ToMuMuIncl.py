...
config.General.requestName = 'ffbar2A3H1ToMuMuIncl-mA3-15-mH1-125_GENSIM_2024_v1'

config.section_('JobType')
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'cfg_ffbar2A3H1ToMuMuIncl-mA3-15-mH1-125_GENSIM.py'
...
config.Data.outputPrimaryDataset = 'ffbar2A3H1ToMuMuIncl-mA3-15-mH1-125_13p6TeV'
