...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/pp/13p6TeV/madgraph/TPrimeToTSTo2Mu/TpToSToMuMu_MS15_el8_amd64_gcc10_CMSSW_12_4_8_tarball.tar.xz'),
