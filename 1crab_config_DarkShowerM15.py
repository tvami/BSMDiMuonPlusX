...
config.General.requestName = 'GluGluHToDarkShowers-ScenarioA_ctau-0p1-mA-15-mpi-35_GENSIM_2024_v1'

config.section_('JobType')
config.JobType.allowUndistributedCMSSW = True
config.JobType.pluginName = 'PrivateMC'
config.JobType.psetName = 'cfg_DarkShower_M15_GS.py'
...
config.Data.outputPrimaryDataset = 'GluGluHToDarkShowers-ScenarioA_ctau-0p1-mA-15-mpi-35_13p6TeV'
