...
# with command line options: --eventcontent NANOAODSIM --datatier NANOAODSIM --conditions 150X_mcRun3_2024_realistic_v2 --step NANO:@Scout --scenario pp --era Run3_2024 --python_filename NanoAODScouting_flat_cfg.py --fileout file:nano_scouting_flat.root --filein file:EXO-RunIII2024Summer24MiniAODv6-01654.root --number 10 --mc
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:nano_scouting_flat'),
