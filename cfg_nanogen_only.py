...
# with command line options: --python_filename cfg_nanogen_only.py --eventcontent NANOAODSIM --datatier NANOAODSIM --filein file:GENSIM.root --fileout file:NanoGen.root --conditions 150X_mcRun3_2024_realistic_v2 --step NANO:@GEN --era Run3_2024 --mc -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:GENSIM_1000.root'),
