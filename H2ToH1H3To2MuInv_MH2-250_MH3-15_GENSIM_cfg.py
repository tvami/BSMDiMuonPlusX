...
# with command line options: Configuration/GenProduction/python/Hadronizer_TuneCP5_13p6TeV_generic_LHE_pythia8_cff.py --era Run3_2024 --beamspot DBrealistic --step LHE,GEN,SIM --geometry DB:Extended --conditions 140X_mcRun3_2024_realistic_v26 --datatier GEN-SIM,LHE --eventcontent RAWSIM,LHE --python_filename TPrime_MS100_GENSIM_cfg.py --fileout file:TPrime_MS100_GENSIM.root --number 100 --number_out 100 --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Hadronizer_TuneCP5_13p6TeV_generic_LHE_pythia8_cff.py nevts:100'),
...
#         filterName = cms.untracked.string('')
#     ),
#     fileName = cms.untracked.string('file:TPrime_MS100_GENSIM_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms-griddata.cern.ch/phys_generator/gridpacks_tarball/pp/13p6TeV/madgraph/H2ToH1H3To2MuInv/H2ToH1H3To2MuInv_MH2-250_MH3-15_slc7_amd64_gcc700_CMSSW_12_4_8_tarball.tar.xz'),
