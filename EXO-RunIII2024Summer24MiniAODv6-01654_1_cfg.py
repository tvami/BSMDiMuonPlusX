...
# with command line options: --eventcontent MINIAODSIM1 --datatier MINIAODSIM --conditions 150X_mcRun3_2024_realistic_v2 --step PAT --geometry DB:Extended --era Run3_2024 --python_filename EXO-RunIII2024Summer24MiniAODv6-01654_1_cfg.py --fileout file:EXO-RunIII2024Summer24MiniAODv6-01654.root --filein file:EXO-RunIII2024Summer24DRPremix-01654.root --number 10 --mc
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:EXO-RunIII2024Summer24DRPremix-01654.root'),
...
process.MINIAODSIM1output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:EXO-RunIII2024Summer24MiniAODv6-01654.root'),
